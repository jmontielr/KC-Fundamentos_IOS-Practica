...
class HeroTableViewCell: UITableViewCell {
    ...
    func updateViews(hero: SuperNaturalPerson) {
        update(image: hero.imageSNP)
        update(nickname: hero.nickname)
        update(sdescription: hero.sdescription)
        update(score: hero.score)
    }
